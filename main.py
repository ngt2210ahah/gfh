...
bot = telebot.TeleBot("6611280193:AAFOGxg2WqicAEZCcmijOx8uZ5g7Ezf9ees")
...
def send_welcome(message):
    ...
    read_gitcodes()
# tác giả HoangAL momo 0919968323. ủng hộ tôi 1k 2k để có động lực .
@bot.message_handler(commands=['gitcode'])
...
def game(message):
    ...
    if message.text == "1":
        ...
        bot.reply_to(message, "HOANGAL\n\n@Nhantaobott : ZALO : 0919968323")
    elif message.text == "7":
...
def animal_selection(message):
    ...
    if message.text in animal_dict:
